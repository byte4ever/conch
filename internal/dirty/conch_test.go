...
func DummyTimeGenerator() dirty.Generator[time.Time] {
...
func DelayTimeGenerator(d time.Duration) dirty.Generator[time.Time] {
	return func(ctx context.Context) (<-chan time.Time, error) {
		output := make(chan time.Time)
...
func DummyGenerator() dirty.Generator[struct{}] {
